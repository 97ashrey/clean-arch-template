...
public class ReActivateSubscriptionCommandHandlerTests : DbContextTestBase
{
    private readonly ReActivateSubscriptionCommandHandler _sut;

    public ReActivateSubscriptionCommandHandlerTests()
    {
        _sut = new(DbContext);
    }
    ...
    {
        // Arrange
        var command = new ReActivateSubscriptionCommand { AccountId = Guid.NewGuid(), Id = Guid.NewGuid() };
    ...
    public async Task Handle_WithActiveSubscription_ReturnsBadRequestError()
    {
        ...
        var command = new ReActivateSubscriptionCommand { AccountId = account.Id, Id = subscription.Id };
    ...
    [Fact]
    public async Task Handle_WithSuspendedSubscription_ReactivatesAndReturnsSubscription()
    {
        // Arrange
        var tenantId = Guid.NewGuid();
        var productId = Guid.NewGuid();
        ...
        result.Value.Status.Should().Be(Domain.Entities.SubscriptionStatus.Active);
