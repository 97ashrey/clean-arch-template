        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AccountOrders_InvoiceAddresses_AccountDetails_InvoiceAddressId",
                        column: x => x.AccountDetails_InvoiceAddressId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Accounts_InvoiceAddresses_InvoiceAddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurchasePrice_Currency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
                    BillCycle = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountOrders_AccountDetails_InvoiceAddressId",
                table: "AccountOrders",
                column: "AccountDetails_InvoiceAddressId");

            migrationBuilder.CreateIndex(
                name: "IX_Accounts_InvoiceAddressId",
                table: "Accounts",
