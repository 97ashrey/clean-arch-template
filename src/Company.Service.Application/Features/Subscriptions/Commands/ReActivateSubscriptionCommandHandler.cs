...
public record ReActivateSubscriptionCommand : ApplicationRequest<Subscription>
{
    public required Guid AccountId { get; init; }
    public required Guid Id { get; init; }
}

internal class ReActivateSubscriptionCommandHandler : IApplicationRequestHandler<ReActivateSubscriptionCommand, Subscription>
{
    private readonly IApplicationDbContext _context;

    public ReActivateSubscriptionCommandHandler(IApplicationDbContext context)
    {
        _context = context;
    }

    public async ValueTask<ValueResult<Subscription, ApplicationError>> Handle(ReActivateSubscriptionCommand request, CancellationToken cancellationToken)
    {
        ...
        return await subscription.ReActivate()
