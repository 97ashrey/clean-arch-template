...
public record CancelSubscriptionCommand : ApplicationRequest<Subscription>
{
    public required Guid AccountId { get; init; }
    public required Guid Id { get; init; }
}

internal class CancelSubscriptionCommandHandler : IApplicationRequestHandler<CancelSubscriptionCommand, Subscription>
{
    ...
    public async ValueTask<ValueResult<Subscription, ApplicationError>> Handle(CancelSubscriptionCommand request, CancellationToken cancellationToken)
    {
